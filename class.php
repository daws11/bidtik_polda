...
<body>
    ...
    <div class="container-fluid p-5">
        <div class="row gx-5">
<h2><a href="class.php">Grafik Jenis dan Case Kamtibmas Umum</a> |  <a href="class2.php">Khusus</a> </h2>
...
$sql="SELECT Waktu FROM `$TABEL` GROUP BY DATE_FORMAT(`Waktu`, '%Y%m') order by Waktu desc  limit 0,12 ";
//where Polsek='
...
while($data = mysqli_fetch_array($ress)) {
	...
	$lap1.="{ Periode: '$periode', ";
		...
		for($j=0;$j<$i;$j++){
			...
			if($jummax<$jumlah){$jummax=$jumlah;}
		}
		$lap1=POT($lap1);
		$lap1.="},";
		$jj++;
...
?>	
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var settings = {
                title: "GRAFIK <?php echo $pagedesc;?>",
            ...
            $("#jqxGrid").jqxGrid({
                ...
                columns:
                [
                    { text: "Periode", width: '40%', datafield: "Periode", 
					filteritems: [<?php echo $per;?>], filtertype: "checkedlist" },
                    <?php echo $lap3;?>
                ]
            });
...
<body class='default'>
    <div id="jqxGrid"></div>
    <div id='jqxChart' style="margin-top: 50px; width: 1700px; height: 400px; position: relative; 
	left: 0px; top: 0px;">
    </div>
