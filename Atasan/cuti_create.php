							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="npp" onBlur="checkNppAvailability()" class="form-control" placeholder="NIK" required>
									...
									<div class="form-group">
										<label class="control-label col-sm-3">Lama Cuti</label>
										<div class="col-sm-4">
											<input type="text" name="nama" class="form-control" placeholder="Lama Cuti" required>
										</div>
									</div>
									<div class="form-group">
