        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/Giat 1.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="" class="btn btn-light py-md-3 px-md-5">Tentang BID TIK</a>-->
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="img/Giat 2.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <!--<h5 class="text-white text-uppercase">BID TIK</h5>
                            <h1 class="display-2 text-white text-uppercase mb-md-4">MENGABDI DENGAN INTEGRASI MELAYANI DENGAN TEKNOLOGI</h1>
        ...
        <div class="row gx-5">
            <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded" src="img/BID-TIK-Polda-NEW.jpg" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="mb-4">
                    <h5 class="text-primary text-uppercase">Tentang Kami</h5>
                    <h1 class="display-3 text-uppercase mb-0">Selamat Datang di Website BID TIK Polda Metro Jaya</h1>
                </div>
                <h4 class="text-body mb-4">Bid TIK bertugas menyelenggarakan pembinaan teknologi informasi dan komunikasi, pengumpulan dan pengolahan data, serta penyajian informasi Kamtibmas dan pelayanan multimedia</h4>
                <p class="mb-4">Dalam melaksanakan tugas, Bid TIK menyelenggarakan fungsi penyusunan  rencana  kerja  dan  anggaran,  pengelolaan  dan pembinaan manajemen personel dan logistik, administrasi dan ketatausahaan, serta pengelolaan keuangan ; 
</p>
                <div class="rounded bg-dark p-5">
                    <ul class="nav nav-pills justify-content-between mb-3">
                        <li class="nav-item w-50">
                            <a class="nav-link text-uppercase text-center w-100 active" data-bs-toggle="pill" href="#pills-1">Lainnya</a>
                        </li>
                        <li class="nav-item w-50">
                                <a class="nav-link text-uppercase text-center w-100" data-bs-toggle="pill" href="#pills-2">Selanjutnya</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="pills-1">
                            <p class="text-secondary mb-0">pembangunan, pembinaan, pemeliharaan jaringan komunikasi dan pengolahan data, serta pelayanan telekomunikasi; pembinaan  dan  penyelenggaraan  sistem  informasi  meliputi sentralisasi pengumpulan dan pengolahan data, pengamanan sistem, penyajian informasi dan dokumentasi, serta analisis dan evaluasi;</p>
                        </div>
                        <div class="tab-pane fade" id="pills-2">
                            <p class="text-secondary mb-0">pembinaan   dan   penyelenggaraan   pusat   sistem   informasi Kamtibmas, meliputi penyiapan dan penyajian data operasional dan pembinaan; dan pemberian  bimbingan,  bantuan  teknis  penyelenggaraan  TIK kepada satuan organisasi di lingkungan Polda.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-5 gb-5">
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded text-center p-5">
                    ...
                    <h3 class="text-uppercase my-4">SUBBAGRENMIN</h3>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded text-center p-5">
                    ...
                    <h3 class="text-uppercase my-4">SUBBIDTEKKOM</h3>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded text-center p-5">
                    ...
                    <h3 class="text-uppercase my-4">SUBBIDTEKINFO</h3>
