...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal" action="Khusus_insert.php" method="POST" enctype="multipart/form-data">
...
<div class="col-sm-4">
								<input type="text" name="Jenis_ppgk" class="form-control" placeholder="Jenis PPGK /Kategori Kasus" title="<?php echo $gab;?>" required>
									...
									<div class="form-group">
										<label class="control-label col-sm-3">Kerugian /Kronologi</label>
										<div class="col-sm-4">
								...
								<div class="panel-footer">
									...
									<a href="Khusus.php" class="btn btn-success">Batal</a>
								</div>
							</div><!-- /.panel -->
						</form>
					</div><!-- /.col-lg-12 -->
