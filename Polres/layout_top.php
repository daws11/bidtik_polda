<?php
	...
	$bulan = date("m");
	$tahun = date("Y");
	$sess_Polresid=$_SESSION["Polres"];
	$sess_Polresname=ucwords($_SESSION["nama_user"]);
	$id=$sess_Polresid;	
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown dropdown-right">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
						<img src="../Gambar/<?php echo $res['foto_emp']?>" width="100px"></i>&nbsp;<?php echo ucfirst($sess_Polresname); ?>&nbsp;<i class="fa fa-caret-down"></i>
					</a>
