<?php
	...
	// deskripsi halaman
	$pagedesc = "Laporan Data ALKOM - Periode " . IndonesiaTgl($mulai) ." - ". IndonesiaTgl($selesai);
...
<body>
				...
				<tbody>
					<tr>
						<td class="text-left" width="20%">
							<img src="Gambar/tik-polri.png" width="100" />
						</td>
						<td class="text-center" width="60%">
						<b>BID TIK POLDA METRO JAYA</b> <br>
						Kompleks Griyaloka Sektor I.1 Blok A1-36, RT.5/RW.13, Bumi Serpong Damai, Tangerang Selatan, Banten 15318<br>
	...
	<section id="body-of-report">
		<div class="container-fluid">
			<h4 class="text-center">LAPORAN DATA ALKOM</h4>
