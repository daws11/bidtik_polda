...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Surat Keluar Internal</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<a href="tambah_internal_keluar.php" class="btn btn-success">Tambah</a>
					...
					<div class="panel-body">
								<table class="table table-striped table-bordered table-hover" id="tabel-data">
									...
									<tbody>
										<?php
											$i = 1;
											$sql = "SELECT * FROM internal_keluar
													INNER join employee on internal_keluar.id_user=employee.id_user
											";
