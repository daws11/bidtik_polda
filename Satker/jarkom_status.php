...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Status Data Pengajuan Jarkom</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
								...
								<table class="table table-striped table-bordered table-hover" id="tabel-data">
									<thead>
										<tr>
											...
											<th width="5%">Tanggal Kegiatan</th>
											<th width="10%">Tempat Kegiatan</th>
											<th width="20%">Nama/No Hp Penanggung Jawab Kegiatan</th>
									...
									<tbody>
										<?php
											$i=1;
											$Sql = "SELECT jarkom.*, employee.* FROM jarkom, employee WHERE jarkom.id_user=employee.id_user AND jarkom.status !='Rejected'
									    AND jarkom.id_user='$id' ORDER BY jarkom.tgl_pengajuan DESC";
