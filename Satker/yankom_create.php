...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Pengajuan Penggunaan Team Yankom</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal" name="cuti" action="yankom_insert.php" method="POST" enctype="multipart/form-data" onSubmit="return valid();">
